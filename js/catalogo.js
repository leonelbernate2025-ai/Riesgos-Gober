...
const CAT = {
  ...
  unidades:[
    {c:"AC-01", n:"Direccion de Atencion al Ciudadano", p:"AC"},
    {c:"AC-02", n:"Grupo de Pasaportes", p:"AC"},
    {c:"DYC-01", n:"Despacho del Gobernador", p:"DYC"},
    {c:"DYC-02", n:"Secretaria Privada", p:"DYC"},
    {c:"DYC-03", n:"Direccion de Gestion y Relaciones Gubernamentales", p:"DYC"},
    {c:"DYC-04", n:"Oficina de Prensa y Comunicaciones", p:"DYC"},
    {c:"GETH-01", n:"Direccion de Talento Humano", p:"GETH"},
    {c:"GETH-02", n:"Grupo de Bienestar Social Laboral", p:"GETH"},
    {c:"PE-01", n:"Despacho Secretaria de Planeacion", p:"PE"},
    {c:"PE-02", n:"Direccion de Desarrollo Regional y Territorial", p:"PE"},
    {c:"PE-03", n:"Direccion de Proyectos y Regalias", p:"PE"},
    {c:"PE-04", n:"Grupo de Evaluacion y Seguimiento", p:"PE"},
    {c:"PE-05", n:"Grupo de Planificacion e Informacion Territorial", p:"PE"},
    {c:"PE-06", n:"Grupo de Proyectos", p:"PE"},
    {c:"PE-07", n:"Grupo de Regalias", p:"PE"},
    {c:"PE-08", n:"Grupo de Rendicion de Cuentas", p:"PE"},
    ...
    {c:"DSC-01", n:"Despacho Secretaria de Cultura y Turismo", p:"DSC"},
    {c:"DSC-02", n:"Direccion de Cultura, Turismo y Patrimonio", p:"DSC"},
    {c:"DSC-03", n:"Despacho Secretaria de Vivienda y Habitat Sustentable", p:"DSC"},
    {c:"DSC-04", n:"Direccion de Desarrollo de Prog. Vivienda y Habitat", p:"DSC"},
    {c:"DSC-05", n:"Despacho Secretaria de Infraestructura", p:"DSC"},
    {c:"DSC-06", n:"Direccion de Proyectos de Infraestructura", p:"DSC"},
    {c:"DSC-07", n:"Grupo de Planificacion y Seguimiento", p:"DSC"},
    {c:"DSC-08", n:"Direccion de Gestion de Infraestructura", p:"DSC"},
    {c:"DSC-09", n:"Grupo de Proyectos Viales", p:"DSC"},
    {c:"DSC-10", n:"Grupo de Proyectos Especiales", p:"DSC"},
    {c:"DSC-11", n:"Grupo de Valorizacion", p:"DSC"},
    {c:"DSC-12", n:"Grupo de Gestion y Supervision", p:"DSC"},
    {c:"DSC-13", n:"Direccion de Aguas", p:"DSC"},
    {c:"DSC-14", n:"Direccion de Asuntos Minero Energeticos", p:"DSC"},
    {c:"DSC-15", n:"Despacho Secretaria Competitividad y Productividad", p:"DSC"},
    {c:"DSC-16", n:"Direccion de Desarrollo Empresarial", p:"DSC"},
    {c:"DSC-17", n:"Grupo de Cooperacion Internacional y Nal.", p:"DSC"},
    {c:"DSC-18", n:"Despacho Secretaria de Agricultura y Desarrollo Rural", p:"DSC"},
    {c:"DSC-19", n:"Grupo de Plan, Analisis, Evaluacion y Seguimiento", p:"DSC"},
    {c:"DSC-20", n:"Direccion de Gestion Rural e Innovacion Agropecuaria", p:"DSC"},
    {c:"DSC-21", n:"Despacho Secretaria Ambiental", p:"DSC"},
    {c:"DSC-22", n:"Direccion de Asuntos Ambientales", p:"DSC"},
    {c:"DSC-23", n:"Despacho Secretaria de Desarrollo Social", p:"DSC"},
    {c:"DSC-24", n:"Direccion de Adulto Mayor y Poblacion con Discapacidad", p:"DSC"},
    {c:"DSC-25", n:"Direccion de Desarrollo Social", p:"DSC"},
    {c:"DSC-26", n:"Grupo de Infancia y Adolescencia", p:"DSC"},
    {c:"DSC-27", n:"Grupo de Politica Social", p:"DSC"},
    {c:"DSC-28", n:"Grupo de Comunidad LGBTIQ", p:"DSC"},
    {c:"DSC-29", n:"Direccion de Juventudes", p:"DSC"},
    {c:"DSC-30", n:"Despacho Secretaria de Mujer y Equidad de Genero", p:"DSC"},
    {c:"DSC-31", n:"Direccion de Equidad de Genero", p:"DSC"},
    {c:"GE-01", n:"Despacho Secretaria de Educacion", p:"GE"},
    {c:"GE-02", n:"Grupo de Planeacion Educativa", p:"GE"},
    {c:"GE-03", n:"Grupo de Inspeccion y Vigilancia", p:"GE"},
    {c:"GE-04", n:"Direccion Estrategica", p:"GE"},
    {c:"GE-05", n:"Grupo de Cobertura Educativa", p:"GE"},
    {c:"GE-06", n:"Grupo de Calidad Educativa", p:"GE"},
    {c:"GE-07", n:"Direccion de Talento Humano Docente", p:"GE"},
    {c:"GE-08", n:"Grupo de Administracion de Planta", p:"GE"},
    {c:"GE-09", n:"Grupo de Desarrollo Docente", p:"GE"},
    {c:"GE-10", n:"Grupo de Carrera Docente", p:"GE"},
    {c:"GE-11", n:"Grupo de Prestaciones Sociales del Magisterio", p:"GE"},
    {c:"GE-12", n:"Grupo de Nomina", p:"GE"},
    {c:"GE-13", n:"Grupo de Historias Labores", p:"GE"},
    {c:"GE-14", n:"Direccion de Permanencia Escolar", p:"GE"},
    {c:"GSS-01", n:"Despacho Secretaria de Salud", p:"GSS"},
    {c:"GSS-02", n:"Direccion de Planeacion y Mejoramiento en Salud", p:"GSS"},
    {c:"GSS-03", n:"Direccion de Salud Integral", p:"GSS"},
    {c:"GSS-04", n:"Direccion de Desarrollo de Servicios Inspeccion Vigilancia y Control", p:"GSS"},
    {c:"GSS-05", n:"Grupo de Epidemiologia y Demografia", p:"GSS"},
    {c:"GSS-06", n:"Grupo de Promocion Social", p:"GSS"},
    {c:"GSS-07", n:"Grupo de Laboratorio y Salud Publica", p:"GSS"},
    {c:"GSS-08", n:"Grupo de Servicios de Salud Individuales", p:"GSS"},
    {c:"GSS-09", n:"Grupo de Gestion de la Salud Ambiental", p:"GSS"},
    {c:"GSS-10", n:"Grupo de Control ETV", p:"GSS"},
    {c:"GSS-11", n:"Grupo de Gestion de Salud Publica", p:"GSS"},
    {c:"GSS-12", n:"Grupo de Aseguramiento y Afiliacion", p:"GSS"},
    {c:"GSS-13", n:"Grupo de CRUE", p:"GSS"},
    {c:"GSS-14", n:"Grupo de Participacion Social en Salud", p:"GSS"},
    {c:"GSS-15", n:"Grupo Acreditacion y SOGC", p:"GSS"},
    {c:"GSS-16", n:"Grupo Administracion Servicios y Gestion Modelo Red Hosp.", p:"GSS"},
    {c:"GSS-17", n:"Grupo de Control Financiera Red Hospitalaria", p:"GSS"},
    {c:"GSS-18", n:"Grupo de Recursos Financieros en Salud", p:"GSS"},
    {c:"GSS-19", n:"Grupo de Atencion al Ciudadano Salud", p:"GSS"},
    {c:"SC-01", n:"Despacho Secretaria del Interior", p:"SC"},
    {c:"SC-02", n:"Grupo de Derechos de Autor", p:"SC"},
    {c:"SC-03", n:"Grupo de Paz y Derechos Humanos", p:"SC"},
    {c:"SC-04", n:"Grupo de Seguridad y Fortalecimiento Municipal", p:"SC"},
    {c:"SC-05", n:"Grupo Asuntos Religiosos", p:"SC"},
    {c:"SC-06", n:"Direccion de Participacion Ciudadana y Accion Comunal", p:"SC"},
    {c:"SC-07", n:"Direccion de Seguridad y Convivencia Ciudadana", p:"SC"},
    {c:"SC-08", n:"Direccion de Atencion Integral a las Victimas", p:"SC"},
    {c:"SC-09", n:"Oficina para la Gestion del Riesgo de Desastres", p:"SC"},
    {c:"AI-01", n:"Despacho Secretaria Administrativa", p:"AI"},
    {c:"AI-02", n:"Grupo Fondo de Cesantias de Santander", p:"AI"},
    {c:"AI-03", n:"Direccion de Recursos Fisicos", p:"AI"},
    {c:"AI-04", n:"Grupo de Administracion de Recursos Fisicos de Salud", p:"AI"},
    {c:"AI-05", n:"Grupo de Bienes y Servicios SED", p:"AI"},
    {c:"AI-06", n:"Oficina de Control Disciplinario", p:"AI"},
    {c:"AI-07", n:"Gestion Documental", p:"AI"},
    {c:"CCP-01", n:"Oficina de Contratacion", p:"CCP"},
    {c:"GF-01", n:"Despacho de Hacienda", p:"GF"},
    {c:"GF-02", n:"Direccion Administrativa y Financiera SED", p:"GF"},
    {c:"GF-03", n:"Direccion Administrativa y de Control Financiero Salud", p:"GF"},
    {c:"GF-04", n:"Direccion de Cobro Coactivo", p:"GF"},
    {c:"GF-05", n:"Direccion de Contabilidad", p:"GF"},
    {c:"GF-06", n:"Direccion de Ingresos", p:"GF"},
    {c:"GF-07", n:"Direccion de Presupuesto", p:"GF"},
    {c:"GF-08", n:"Direccion de Tesoreria", p:"GF"},
    {c:"GF-09", n:"Direccion Fondo Territorial de Pensiones", p:"GF"},
    ...
    {c:"GJ-05", n:"Grupo de Apoyo Juridico SED", p:"GJ"},
    {c:"GJ-06", n:"Direccion de Apoyo Juridico Contratacion y P. Sancionatorios", p:"GJ"},
    {c:"TIC-01", n:"Despacho Secretaria TIC", p:"TIC"},
    {c:"TIC-02", n:"Direccion de Gobierno Digital", p:"TIC"},
    {c:"TIC-03", n:"Direccion de Sistemas de Informacion", p:"TIC"},
    {c:"CE-01", n:"Oficina de Control Interno", p:"CE"}
  ],
